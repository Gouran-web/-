      ...
      <div class="banner-text">
        ...
        <span>
          <el-collapse v-model="activeNames">
            <el-collapse-item title="Dcoit完整的微服务架构" name="1">
              <div>基于Spring Cloud Greenwich.SR2</div>
              <div>基于Spring Boot 2.1.7.RELEASE</div>
            </el-collapse-item>
            <el-collapse-item title="Dcoit完美的容器化支持" name="2">
              <div>支持docker部署</div>
              <div>支持Rancher2 + Kubernetes部署</div>
            </el-collapse-item>
            <el-collapse-item title="Dcoit最终一致性分布式事务" name="3">
            ...
            <el-collapse-item title="其他功能" name="4">
              <div>SAAS多租户</div>
              <div>Activiti工作流</div>
              <div><a href="https://www.dcoit.com/#/vip" target="_blank">详细介绍Dcoit </a></div>
            </el-collapse-item>
          </el-collapse>
        </span>
      </div>
...
export default {
  ...
  methods: {
    ...
    redirect() {
      this.$router.push(
        "/myiframe/urlPath?name=%E9%87%87%E6%B2%B9%E5%8A%A8%E6%80%81&src=http%3A%2F%2Foo-znzc-web-znzc-cy.tjdevapp.cnooc%2F%23%2Fhome"
      );
    },
  },
  created() {
